...
Again, one Aggregator initiates the computation. This Aggregator is called as
...
proof systems than considered here. In particular, what is called an "FLP"
...
the field are used. This allows us to construct each gadget polynomial via the
...
valid; a successful preparation is represented with the empty string and

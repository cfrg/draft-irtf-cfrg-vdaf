...
* IdpfPoplar: Replace XofShake128 with XofFixedKeyAes128, a fixed-key mode for
...
* Idpf: Add a binder string to the key-generation and evaluation algorithms.
  This is used to plumb the nonce generated by the Client to the XOF.
...
* Xof: Split "info string" into two components: the "customization string",
...
* Replace XofAes128 with XofShake128, an implementation of the Xof interface based
...
* Prio3, Poplar1: Ensure each invocation of the Xof uses a distinct
...
* Poplar1: Use different Xof invocations for producing the correlated randomness
...
* Prio3: Remove an intermediate XOF evaluation from query randomness generation.
  (\*)
...
* Xof: Add a method for statefully generating a vector of field elements.
